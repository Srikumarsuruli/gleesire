        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <?php endif; ?>
                    <?php if(hasPrivilege('view_leads') || hasPrivilege('fixed_package_lead') || hasPrivilege('custom_package_leads') || hasPrivilege('medical_tourism_leads') || hasPrivilege('lost_to_competitors') || hasPrivilege('no_response_leads') || hasPrivilege('follow_up_leads') || $_SESSION["role_id"] == 1): ?>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <?php if(hasPrivilege('user_performance_report') || $_SESSION["role_id"] == 1): ?><li><a href="under_construction.php?page=User Performance Report">User Performance Report</a></li><?php endif; ?>
                            <?php if(hasPrivilege('package_performance_report') || $_SESSION["role_id"] == 1): ?><li><a href="under_construction.php?page=Package Performance Report">Package Performance Report</a></li><?php endif; ?>
                            <?php if(hasPrivilege('marketing_performance_report') || $_SESSION["role_id"] == 1): ?><li><a href="under_construction.php?page=Marketing Performance Report">Marketing Performance Report</a></li><?php endif; ?>
                        </ul>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            <?php if(hasPrivilege('transportation_details') || $_SESSION["role_id"] == 1): ?><li><a href="under_construction.php?page=Transportation Details">Transportation Details</a></li><?php endif; ?>
                            <?php if(hasPrivilege('accommodation_details') || $_SESSION["role_id"] == 1): ?><li><a href="under_construction.php?page=Accommodation Details">Accommodation Details</a></li><?php endif; ?>
                            <?php if(hasPrivilege('cruise_details') || $_SESSION["role_id"] == 1): ?><li><a href="under_construction.php?page=Cruise Details">Cruise Details</a></li><?php endif; ?>
                            <?php if(hasPrivilege('extras_miscellaneous_details') || $_SESSION["role_id"] == 1): ?><li><a href="under_construction.php?page=Extras/Miscellaneous Details">Extras/Miscellaneous Details</a></li><?php endif; ?>
                        </ul>
                    </li>
                    <?php endif; ?>
