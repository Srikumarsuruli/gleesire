...
$base_sql = "SELECT e.*, u.full_name as attended_by_name, d.name as department_name, 
        ...
        WHERE e.enquiry_type = 'Ticket Enquiry'";
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Ticket Enquiry Filters</h4>
    </div>
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Ticket Enquiry (<?php echo $total_records; ?> total)</h4>
    </div>
    <div class="pb-20">
