...
$sql = "SELECT e.*, u.full_name as attended_by_name, d.name as department_name, 
        ...
        WHERE lsm.status_name = 'Call Back - Call Back Scheduled'";
...
// Get users for filter dropdown - only those with follow up leads
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Follow Up Leads (<?php echo $total_records; ?> total)</h4>
    </div>
    <div class="pb-20">
