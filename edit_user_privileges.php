...
// Check if role_id parameter exists
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($delete_stmt = mysqli_prepare($conn, $delete_sql)) {
        ...
        if($insert_stmt = mysqli_prepare($conn, $insert_sql)) {
            ...
            $success = "Privileges updated successfully for " . htmlspecialchars($role_name) . ".";
...
<div class="row">
    <div class="col-md-12">
        <h2 class="mb-4">Edit User Privileges - <?php echo htmlspecialchars($role_name); ?></h2>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Manage Privileges for <?php echo htmlspecialchars($role_name); ?></h5>
            </div>
            <div class="card-body">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?role_id=' . $role_id; ?>" method="post">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <a href="user_privileges.php" class="btn btn-secondary">Back to User Privileges</a>
                        </div>
                    </div>
                </form>
            </div>
