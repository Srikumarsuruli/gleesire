-- Status Change Logging Database Script
-- Run this script on your server to create the necessary tables for status change tracking
...
ALTER TABLE lead_status_map ADD COLUMN last_reason VARCHAR(100) NULL;