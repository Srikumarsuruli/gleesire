...
$base_sql = "SELECT e.*, u.full_name as attended_by_name, d.name as department_name, 
        ...
        WHERE e.enquiry_type = 'Vloggers / Influencers'";
...
// Get users for filter dropdown - only those who attended enquiries that are in booking confirmed
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Vloggers / Influencers Filters</h4>
    </div>
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Vloggers / Influencers Enquiry (<?php echo $total_records; ?> total)</h4>
    </div>
    <div class="pb-20">
