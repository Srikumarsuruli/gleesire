<?php
// Enhanced PDF template with improved design and complete data display
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <div class="header">
            <img src="assets/deskapp/vendors/images/custom-logo.svg" alt="Logo" class="logo">
        ...
        <div class="info-grid">
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><?php echo date('d-m-Y H:i', strtotime($cost_sheet['created_at'])); ?></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Updated:</div>
                    <div class="info-value"><?php echo date('d-m-Y H:i', strtotime($cost_sheet['updated_at'])); ?></div>
                </div>
                <div class="info-row">
