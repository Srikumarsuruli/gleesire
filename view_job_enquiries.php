...
// Build the base SQL query with filters - ONLY Job Enquiry type
$base_sql = "SELECT e.*, u.full_name as attended_by_name, d.name as department_name, 
        ...
        WHERE e.enquiry_type = 'Job Enquiry'";
...
// Get users for filter dropdown - only those who have attended enquiries with booking confirmations
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Job Enquiries Filters</h4>
    </div>
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">Job Enquiries (<?php echo $total_records; ?> total)</h4>
    </div>
    <div class="pb-20">
