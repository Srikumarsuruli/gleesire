...
$attended_by = $status_id = $search = $date_filter = $lead_type = "";
$start_date = $end_date = "";
...
$count_sql = str_replace("SELECT e.*, u.full_name as attended_by_name, d.name as department_name, s.name as source_name, ac.name as campaign_name, ls.name as status_name", "SELECT COUNT(*)", $base_sql);
