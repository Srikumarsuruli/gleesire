...
// Build the base SQL query with filters - ONLY No Response status
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">No Response/Rejected Enquiries Filters</h4>
    </div>
    ...
    <div class="pb-20">
        <table class="data-table table stripe hover nowrap">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="11" class="text-center">No "No Response" enquiries found</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
