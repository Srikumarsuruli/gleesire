...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">Completed Bookings (<?php echo $total_records; ?> total)</h4>
            </div>
            <div class="pb-20">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                ...
                                                <a class="dropdown-item" href="generate_invoice.php?id=<?php echo $row['cost_sheet_id']; ?>">
                                                    <i class="dw dw-invoice"></i> Generate Invoice
                                                </a>
                                               
                                                <a class="dropdown-item" href="download_receipts.php?id=<?php echo $row['cost_sheet_id']; ?>">
                                                    <i class="dw dw-file"></i> Download Receipts
                                                </a>
                                            </div>
                                        </div>
