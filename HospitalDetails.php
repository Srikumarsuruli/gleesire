...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    $delete_sql = "DELETE FROM hospital_details WHERE id = ?";
    if ($stmt = mysqli_prepare($conn, $delete_sql)) {
        mysqli_stmt_bind_param($stmt, "i", $delete_id);
        if (mysqli_stmt_execute($stmt)) {
            echo "<script>alert('Hospital detail deleted successfully'); window.location.href='HospitalDetails.php';</script>";
        }
        mysqli_stmt_close($stmt);
    }
}

$sql = "SELECT * FROM hospital_details ORDER BY created_at DESC";
...
<div class="card-box mb-30">
    <div class="pd-20">
        <div class="row">
            <div class="col-md-6">
                <h4 class="text-blue h4">Hospital Details</h4>
            </div>
            <div class="col-md-6 text-right">
                <a href="add_hospital_detail.php" class="btn btn-primary">
        ...
        <div class="table-responsive">
            <table class="data-table table stripe hover" style="width: 100%; min-width: 1000px;">
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 150px;">Hospital Name</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_hospital_detail.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">
                            <i class="fa fa-edit"></i>
                        </a>
                        <a href="HospitalDetails.php?delete=<?php echo $row['id']; ?>" 
                           class="btn btn-sm btn-danger" 
                           onclick="return confirm('Are you sure you want to delete this hospital detail?')">
                ...
                ?>
                <tr>
                    <td colspan="9" class="text-center">No hospital details found</td>
                </tr>
                <?php endif; ?>
            </tbody>
            </table>
