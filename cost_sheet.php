                ...
                <div class="col-md-12 table-responsive">
                    ...
                    <table class="table table-bordered table-sm" style="table-layout: fixed; width: 100%;">
                        <tr>
                            ...
                            <td class="font-weight-bold" width="20%"><?php echo htmlspecialchars($enquiry['customer_name']); ?></td>
                        ...
                        <tr>
                            ...
                            <td class="bg-light" style="font-size: 0.8rem;"><strong>BOOKING DATE</strong></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control form-control-sm" name="currency" id="currency-select">
                                    <option value="USD" data-symbol="$" <?php echo (isset($currency) && $currency == 'USD') ? 'selected' : ''; ?>>USD</option>
                                    <option value="EUR" data-symbol="€" <?php echo (isset($currency) && $currency == 'EUR') ? 'selected' : ''; ?>>EUR</option>
                                    <option value="GBP" data-symbol="£" <?php echo (isset($currency) && $currency == 'GBP') ? 'selected' : ''; ?>>GBP</option>
                                    <option value="INR" data-symbol="₹" <?php echo (isset($currency) && $currency == 'INR') ? 'selected' : ''; ?>>INR</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
