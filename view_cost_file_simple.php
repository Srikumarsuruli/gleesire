...
<div class="cost-file-container">
    <div class="cost-file-card">
        <div class="cost-file-header">
            <h1 class="cost-file-title">Cost File Details (View Only)</h1>
            ...
            <div style="margin-top: 20px;">
                <a href="edit_cost_file.php?id=<?php echo $cost_file_id; ?>" class="btn btn-sm btn-primary">
                    <i class="fa fa-edit"></i> Edit Cost File
                </a>
                <a href="view_cost_sheets.php" class="btn btn-sm btn-secondary">
        ...
        <div id="cost-file-view">
            ...
            <div class="services-summary" style="margin-top: 30px;">
                <h5><i class="fas fa-list"></i> Service Details Summary</h5>
            ...
            <!-- Cost Summary -->
            <div class="cost-summary" style="margin-top: 30px;">
            ...
            <div class="payment-management-section" style="margin-top: 30px;">
                <div class="info-card">
